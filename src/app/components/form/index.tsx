    ...
    <div className="isolate px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 dark:text-sky-500">
          Ready to elevate your digital presence? Let's connect and bring your
          vision to life! Contact us for expert web and mobile app development
          services. Your success is just a message away 🚀✨
        </p>
      </div>
